...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \label{fig:proc_1}
        \caption{Diagrama de flujo resumen del experimento 1 \cite{lab}}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \label{fig:proc_2}
        \caption{Diagrama de flujo resumen del experimento 2 \cite{lab}}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \node (cuadro5) [naranja, below = 0.9cm of cuadro3] {Anotar los datos medidos del experimento.};
        ...
        \end{center}
        \label{fig:proc_3}
        \caption{Diagrama de flujo resumen del experimento 3 \cite{lab}}
    \end{figure}
